package luccas.dev.insurancecalculator.infrastructure.exceptions;

import luccas.dev.insurancecalculator.application.exceptions.NotFoundException;
import luccas.dev.insurancecalculator.infrastructure.controllers.dtos.response.ErrorResponse;
